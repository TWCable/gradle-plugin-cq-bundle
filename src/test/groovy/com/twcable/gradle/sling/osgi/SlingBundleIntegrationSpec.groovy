...
//    def "remove bundle"() {
//        expect:
//        slingBundle.removeBundle(configuration.slingSupport, configuration.slingSupport.slingSupport.slingSupport, slingBundle.getBundleLocation(configuration.slingSupport, configuration.slingSupport.slingSupport.name, configuration.slingSupport.slingSupport.slingSupport, configuration.slingSupport.slingSupport.bundleControlBaseUri))
//    }
//
//
//    def "start bundle"() {
...
//        slingSupport.metaClass.createHttpClient = { ->
//            createHttpClient(HTTP_OK, new StringEntity(jsonBuilder.toString()))
//        }
//
//        expect:
//        slingBundle.uploadBundle().code == HTTP_OK
//    }
//
//
